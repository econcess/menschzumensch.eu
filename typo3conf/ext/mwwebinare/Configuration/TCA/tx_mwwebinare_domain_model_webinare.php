...
return [
    ...
    'interface' => [
        'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, titel, versionsschulung, wichtigsteninfos, beschreibung, link, linktext, standort, dauer, grueneslabel, status, buttonbuchendeaktiv, verfuegbarkeit, ticket, ticketverfuegbar, path_segment, bilder, video, youtubecode, termine, kategorien, experten, formularauswahl, formularauswahlint, registrationaddress, registrationpage, registrationaddressext',
    ],
    'types' => [
         '1' => ['showitem' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, titel, versionsschulung, wichtigsteninfos, beschreibung, link, linktext, standort, grueneslabel, status, buttonbuchendeaktiv, verfuegbarkeit, ticket, ticketverfuegbar, path_segment,--div--;Termine und Dauer, dauer, termine, --div--;Bild und Video, bilder, video, youtubecode, --div--;Relationen, kategorien, experten, registrationaddress, --div--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:tabs.access, starttime, endtime'],
    ],
    'columns' => [
        'sys_language_uid' => [
            'exclude' => true,
